...
// New function returns an initialised Bitset with optional initial bits v.
...
// NewFromBase2String constructs and returns a Bitset from a string
// The string consists of '1', '0' or '' characters, e.g: "1010 0101".
// The '1' and '0' characters represent true/false bits respectively,
...
//
// The underlying array is expanded if necessary, To prevent frequest
...
//
// The new length if b.Len() + other.Len().
...
// AppendNumBools appends num bits to Bitset
...
// Len returns then length of the Bitset in bits.
...
func (b *Bitset) Equals(other *Bitset) bool {
	...
	if !bytes.Equal(b.bits[0:b.numBits/8], other.bits[0:other.numBits/8]) {
		return false
	}
...
// ByteAt returns a byte consisting if upto 8 bits starting at index
